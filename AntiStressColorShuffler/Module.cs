...
namespace AntiStressColorShuffler
{
    class Module
    {
        ...
        public static string ApplicationName = "Anti Stress Color Shuffler";
        ...
        public static string DownloadURL = "https://www.4dots-software.com/d/AntiStressColorShuffler/";
        public static string HelpURL = "https://www.4dots-software.com/anti-stress-color-shuffler/how-to-use.php";
        public static string ProductWebpageURL = "https://www.4dots-software.com/anti-stress-color-shuffler/";
        public static string BuyURL = "https://www.4dots-software.com/store/buy-anti-stress-color-shuffler.php";
        public static string VersionURL = "http://cssspritestool.com/versions/anti-stress-color-shuffler.txt";

        public static string TipText = TranslateHelper.Translate("Great application to relieve stress !");        

        public static List<string> GeneratedTemporaryFiles = new List<string>();        
        
        public static string OpenFilesFilter =
            "Word Files (*.doc;*.docx;*.dot;*.dotx;*.rtf;*.odt;*.docm;*.dotm)|*.doc;*.docx;*.dot;*.dotx;*.rtf;*.odt;*.docm;*.dotm|All Files (*.*)|*.*";
        ...
        public static void ShowError(string msg)
        {
            ...
            else
            {
                try
                {
                    //1frmError f = new frmError("Error", msg);
                    //1f.ShowDialog();
                }
                catch
                {
