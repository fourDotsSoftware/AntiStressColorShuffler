...
;copy translations end
  ...
  !define MUI_FILE "AntiStressColorShuffler"
  !define MUI_VERSION ""
  !define MUI_PRODUCT "Anti Stress Color Shuffler"
  !define PRODUCT_SHORTCUT "Anti Stress Color Shuffler"
  !define PRODUCT_VERSION "1.0"
  
  !define MUI_ICON "anti-stress-color-shuffler-48.ico"
...
;  !define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\readme.txt"
  ...
  Name "Anti Stress Color Shuffler"
  OutFile "AntiStressColorShufflerSetup.exe"

  InstallDir "$PROGRAMFILES\4dots Software\${PRODUCT_SHORTCUT}"

  InstallDirRegKey HKLM "Software\4dots Software\Anti Stress Color Shuffler" ""
...
;create start-menu items
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\Anti Stress Color Shuffler - User's Manual.url.lnk" "$INSTDIR\Anti Stress Color Shuffler - User's Manual.url" "" "$INSTDIR\Anti Stress Color Shuffler - User's Manual.url" 0
...
;  ExecWait "$PLUGINSDIR\Installmanager.exe 015" 
 ...
 ; File "readme.txt"
  ;File "..\..\..\helpfile\Anti Stress Color Shuffler - User's Manual.chm";
  File "Anti Stress Color Shuffler - User's Manual.url";
  ;1File "ddb.dat"
...
;write uninstall information to the registry
 ...
 ;Store installation folder
  WriteRegStr HKLM "Software\4dots Software\Anti Stress Color Shuffler" "" $INSTDIR
  WriteRegStr HKLM "Software\4dots Software\Anti Stress Color Shuffler" "InstallationDirectory" $INSTDIR
...
;Delete Uninstaller And Unistall Registry Entries
  ...
  DeleteRegKey HKLM "Software\4dots Software\Anti Stress Color Shuffler"
  DeleteRegKey HKCU "Software\4dots Software\Anti Stress Color Shuffler"
...
Function .onInstSuccess
 ...
 ExecShell "" "https://www.4dots-software.com/anti-stress-color-shuffler/?afterinstall=true&version=${PRODUCT_VERSION}";
...
Function OpenWebpageFunction
  ExecShell "" "http://www.4dots-software.com/anti-stress-color-shuffler/?afterinstall=true"
FunctionEnd
