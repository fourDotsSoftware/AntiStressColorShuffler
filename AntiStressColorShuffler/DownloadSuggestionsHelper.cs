...
namespace AntiStressColorShuffler
{
    class DownloadSuggestionsHelper
    {
        ...
        public void SetupDownloadMenuItems(ToolStripMenuItem tsiDownload)
        {
            ...
            Url.Add("http://www.4dots-software.com/d/ConvertPowerpointToExe/");            

            Url.Add("http://www.4dots-software.com/d/ConvertWordToExe/");

            Url.Add("http://www.4dots-software.com/d/ConvertExcelToExe/");
            ...
            Url.Add("http://www.4dots-software.com/d/StandaloneEXELocker/");
            ...
            Url.Add("http://www.4dots-software.com/d/EXESlideshowMaker/");
            ...
            Url.Add("http://www.4dots-software.com/d/AntiStressColorShuffler/");

            Url.Add("http://www.4dots-software.com/d/FreeDocusTree/");

            Url.Add("http://www.4dots-software.com/d/StandaloneEXEDocumentLocker/");            
            ...
            App.Add("Convert Powerpoint to EXE 4dots");            

            App.Add("Convert Word to EXE 4dots");

            App.Add("Convert Excel to EXE 4dots");
            ...
            App.Add("EXE Slideshow Maker 4dots");
            ...
            App.Add("Anti Stress Color Shuffler");

            App.Add("Free DocusTree");

            App.Add("Standalone EXE Document Locker");
